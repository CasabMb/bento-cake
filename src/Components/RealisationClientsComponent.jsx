    ...
    return <>
        <section className='realisations'>
            ...
            <div className="grid-container">
                <div className="grid-item img1"><img src={img1} alt="Image 1" /></div>
                <div className="grid-item img2"><img src={img3} alt="Image 3" /></div>
                <div className="grid-item img3"><img src={img2} alt="Image 2" /></div>
                <div className="grid-item img4"><img src={img7} alt="Image 3" /></div>
                <div className="grid-item img5"><img src={img4} alt="Image 4" /></div>
                <div className="grid-item img6"><img src={img5} alt="Image 5" /></div>
                <div className="grid-item img7"><img src={img3} alt="Image 7" /></div>
