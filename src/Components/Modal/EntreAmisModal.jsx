    ...
    return (
        <section className='entre-amis'>
            <div className="modal-overlay " onClick={toggleModal}>
                <div className="modal-content entre-amis-container" onClick={(e) => e.stopPropagation()}>
                        <h2>Atelier Gourmand Entre Amis</h2>
                        <p>
                            Envie d’un moment convivial et gourmand ? Que vous soyez entre amis, en famille ou en couple, cet atelier est fait pour vous !
                        </p>
                        <div className='modal-boxes'>
                            ...
                            <div className="modal-infos">
                                ...
                                <p><span>⏳ Durée :</span> En atelier privé</p>
